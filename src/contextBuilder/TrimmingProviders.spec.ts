...
import { chain, interweave, flatMap, iterReverse } from "@utils/iterables";
...
import type { TrimProvider } from "./TrimmingProviders";
...
describe("comment removal", () => {
  ...
  describe("`doNotTrim` provider", () => {
    ...
    it("should have a noop `newline` method", () => {
      ...
      expect(toOutput(fragments, provider)).toBe("");
    });
  });
});